...
class Potassium_OBS_Controller:
    def __init__(self, top=None):
        ...
        self.Entry1.place(relx=0.03, rely=0.18, relheight=0.04, relwidth=0.21)
        self.Entry1.configure(background="white")
        self.Entry1.configure(font="TkFixedFont")
        self.Entry1.configure(selectbackground="#c4c4c4")
        self.Entry1.configure(textvariable=gui_support.P1_Entry)

        self.Entry1T = Entry(top)
        self.Entry1T.place(relx=0.03, rely=0.24, relheight=0.04, relwidth=0.21)
        self.Entry1T.configure(background="#AFEFFF")
        self.Entry1T.configure(font="TkFixedFont")
        self.Entry1T.configure(selectbackground="#c4c4c4")
        self.Entry1T.configure(textvariable=gui_support.P1T_Entry)
        ...
        self.Entry2.place(relx=0.26, rely=0.18, relheight=0.04, relwidth=0.21)
        self.Entry2.configure(background="white")
        self.Entry2.configure(font="TkFixedFont")
        self.Entry2.configure(selectbackground="#c4c4c4")
        self.Entry2.configure(textvariable=gui_support.P2_Entry)

        self.Entry2T = Entry(top)
        self.Entry2T.place(relx=0.26, rely=0.24, relheight=0.04, relwidth=0.21)
        self.Entry2T.configure(background="#AFEFFF")
        self.Entry2T.configure(font="TkFixedFont")
        self.Entry2T.configure(selectbackground="#c4c4c4")
        self.Entry2T.configure(textvariable=gui_support.P2T_Entry)
        ...
        self.Entry3.place(relx=0.5, rely=0.18, relheight=0.04, relwidth=0.21)
        self.Entry3.configure(background="white")
        self.Entry3.configure(font="TkFixedFont")
        self.Entry3.configure(selectbackground="#c4c4c4")
        self.Entry3.configure(textvariable=gui_support.P3_Entry)

        self.Entry3T = Entry(top)
        self.Entry3T.place(relx=0.5, rely=0.24, relheight=0.04, relwidth=0.21)
        self.Entry3T.configure(background="#AFEFFF")
        self.Entry3T.configure(font="TkFixedFont")
        self.Entry3T.configure(selectbackground="#c4c4c4")
        self.Entry3T.configure(textvariable=gui_support.P3T_Entry)
        ...
        self.Entry4.place(relx=0.75, rely=0.18, relheight=0.04, relwidth=0.21)
        self.Entry4.configure(background="white")
        self.Entry4.configure(font="TkFixedFont")
        self.Entry4.configure(selectbackground="#c4c4c4")
        self.Entry4.configure(textvariable=gui_support.P4_Entry)

        self.Entry4T = Entry(top)
        self.Entry4T.place(relx=0.75, rely=0.24, relheight=0.04, relwidth=0.21)
        self.Entry4T.configure(background="#AFEFFF")
        self.Entry4T.configure(font="TkFixedFont")
        self.Entry4T.configure(selectbackground="#c4c4c4")
        self.Entry4T.configure(textvariable=gui_support.P4T_Entry)
        ...
        self.Player1_Wins = Entry(top)
        self.Player1_Wins.place(relx=0.15, rely=0.4, relheight=0.04
                , relwidth=0.21)
        self.Player1_Wins.configure(background="white")
        self.Player1_Wins.configure(font="TkFixedFont")
        ...
        self.Entry8.place(relx=0.63, rely=0.4, relheight=0.04, relwidth=0.21)
        self.Entry8.configure(background="white")
        self.Entry8.configure(font="TkFixedFont")
        self.Entry8.configure(selectbackground="#c4c4c4")
        self.Entry8.configure(textvariable=gui_support.P2_Wins)
        ...
        self.Entry10.place(relx=0.63, rely=0.53, relheight=0.04, relwidth=0.21)
        ...
        self.Entry10.configure(textvariable=gui_support.Com2_Entry)
